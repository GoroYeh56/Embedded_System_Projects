...
//Two Task : 
//1. Compute PID & write Servo motor.(Get MSP & Joysticks.)
//2. Display LCD.
//3. Display RGB
...
//      if(Your_hand >=100){ //User want to cheat and hurt your servo.
...
//              else if(distance>=44){distance = distance-10;}
              ...
              if(distance_error>=-2 && distance_error <= 2 ){
                PID_total = 80; //Stop.
                  ...
                  if(-5 < distance_error && distance_error < 10)
                  {
                  ...
                  lcd.print("cm");
                      //RGB       
                         if(distance_error >= -2 && distance_error <=2){ //start counting.
                            ...
                            if(count>= 500/portTICK_PERIOD_MS){//greater than 2 sec balance.
                                 mode = Auto;
...
//         Serial.println(hand_distance);
         delay(100); //Sample period should longer than 65ms
